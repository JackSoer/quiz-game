export default class QuizesModel {
  constructor() {
    this.quizes = [
      {
        category: 'Comics',
        ...
        questions: [
          ...
          },
          {
            ...
            answers: [
              ...
              {
                answer: 'Gave him an exquisite singing voice',
                isCorrect: false,
              },
            ],
          },
        ...
        questions: [
          {
            ...
            answers: [
              { answer: 'Jacob', isCorrect: false },
              { answer: 'Walter', isCorrect: false },
              { answer: 'Joseph', isCorrect: true },
              { answer: 'Thomas', isCorrect: false },
            ],
          },
          {
            id: 2,
            questionImg: 'Phantom_Zone.jpg',
            question:
              'What is the name of the dimensional plane where Kryptonian criminals were exiled for their crimes?',
            answers: [
              { answer: 'Phantom Zone', isCorrect: true },
              { answer: "Zimbardo's prison", isCorrect: false },
              { answer: 'Bizarro World', isCorrect: false },
              { answer: "No Man's Land", isCorrect: false },
            ],
          },
          {
            id: 3,
            questionImg: 'Superman_Man_of_Steel_Vol_1_75.webp',
            question:
              'What super-villain killed the Man of Steel in Superman #75?',
            answers: [
              { answer: 'Darkseid', isCorrect: false },
              { answer: 'Brainiac', isCorrect: false },
              { answer: 'Doomsday', isCorrect: true },
              { answer: 'Lex Luthor', isCorrect: false },
            ],
          },
          {
            id: 4,
            questionImg: 'Superman_Ins_Queen.webp',
            question:
              "Which of Superman's sweethearts became the super-heroine known as Insect Queen?",
            answers: [
              { answer: 'Lana Lang', isCorrect: true },
              { answer: 'Lori Lemaris', isCorrect: false },
              { answer: 'Lyla Lerrol', isCorrect: false },
              { answer: 'Lois Lane', isCorrect: false },
            ],
          },
          {
            id: 5,
            questionImg: 'Who_Created_Superman.jpg',
            question: 'Who created Superman?',
            answers: [
              { answer: 'Jack Kirby & Bob Kane', isCorrect: false },
              { answer: 'Jerry Siegel & Joe Shuster', isCorrect: true },
              { answer: 'Bob Kane & Joe Shuster', isCorrect: false },
              { answer: 'jerry Siegel & Stan Lee', isCorrect: false },
            ],
          },
          {
            id: 6,
            questionImg: 'perry.png',
            question:
              "Who is the natural father of Daily Planet editor Perry White's son Jerry?",
            answers: [
              { answer: 'Bizarro Perry White', isCorrect: false },
              { answer: 'Bibbo Bibbowski', isCorrect: false },
              { answer: 'Lex Luthor', isCorrect: true },
              { answer: 'Emil Hamilton', isCorrect: false },
            ],
          },
          {
            id: 7,
            questionImg: 'superman_family.jpg',
            question:
              'What member of the Superman family died in Crisis on Infinite Earths?',
            answers: [
              { answer: 'Jimmy Olson', isCorrect: false },
              { answer: 'Supergirl', isCorrect: true },
              { answer: 'Superman', isCorrect: false },
              { answer: 'Lois Lane', isCorrect: false },
            ],
          },
          {
            id: 8,
            questionImg: 'superman_kiss.jpg',
            question: 'When did Lois and Superman first kiss?',
            answers: [
              { answer: 'Superman #248', isCorrect: false },
              { answer: 'Action comics #1', isCorrect: false },
              { answer: 'Action comics #124', isCorrect: false },
              { answer: 'Superman #3', isCorrect: true },
            ],
          },
          {
            id: 9,
            questionImg: 'Kal_El.png',
            question: "What is Superman's Kryptonian name?",
            answers: [
              { answer: 'Jor-El', isCorrect: false },
              { answer: 'Zor-El', isCorrect: false },
              { answer: 'Kal-El', isCorrect: true },
              { answer: 'Jimbo', isCorrect: false },
            ],
          },
          {
            id: 10,
            questionImg: 'lara.png',
            question: "What was the name of Superman's birth mother?",
            answers: [
              { answer: 'Lara', isCorrect: true },
              { answer: 'Faora', isCorrect: false },
              { answer: 'Kara', isCorrect: false },
              { answer: 'Xala', isCorrect: false },
            ],
          },
        ],
      },
